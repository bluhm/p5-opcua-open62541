...
open(my $af, '>', "Open62541-client-read-async.xsh")
    or die "Open 'Open62541-client-read-async.xsh' for writing failed: $!";
print $af "# begin generated by $0\n\n";
...
print $af "# end generated by $0\n";
close($af) or die
    "Close 'Open62541-client-read-async.xsh' after writing failed: $!";
