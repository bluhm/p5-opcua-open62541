...
# script/constant-define.pl ACCESSLEVELMASK constants

package OPCUA::Open62541::ACCESSLEVELMASK;
...
OPCUA::Open62541::ACCESSLEVELMASK - import ACCESSLEVELMASK defines from constants.h

=head1 SYNOPSIS

  use OPCUA::Open62541::ACCESSLEVELMASK;

  use OPCUA::Open62541::ACCESSLEVELMASK qw(ACCESSLEVELMASK_READ ...);

  use OPCUA::Open62541::ACCESSLEVELMASK ':all';

=head1 DESCRIPTION

This module provides all ACCESSLEVELMASK defines as Perl constants.
...
Exports all ACCESSLEVELMASK constants into the OPCUA::Open64541 name space.
