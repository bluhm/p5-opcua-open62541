...
# script/constant.pl enum NODEIDTYPE types

package OPCUA::Open62541::NODEIDTYPE;
...
OPCUA::Open62541::NODEIDTYPE - enum NODEIDTYPE from types.h

=head1 SYNOPSIS

  use OPCUA::Open62541;

  use OPCUA::Open62541 qw(NODEIDTYPE_NUMERIC ...);

  use OPCUA::Open62541 ':NODEIDTYPE';

=head1 DESCRIPTION

This module provides all NODEIDTYPE enums as Perl constants.
...
=item NODEIDTYPE_NUMERIC

=item ...

=item NODEIDTYPE_BYTESTRING

Export specific NODEIDTYPE constants into the OPCUA::Open64541 name
space.

=item :NODEIDTYPE

Exports all NODEIDTYPE constants into the OPCUA::Open64541 name space.
