...
# script/constant.pl enum BROWSERESULTMASK types_generated

package OPCUA::Open62541::BROWSERESULTMASK;
...
OPCUA::Open62541::BROWSERESULTMASK - enum BROWSERESULTMASK from types_generated.h

=head1 SYNOPSIS

  use OPCUA::Open62541;

  use OPCUA::Open62541 qw(BROWSERESULTMASK_NONE ...);

  use OPCUA::Open62541 ':BROWSERESULTMASK';

=head1 DESCRIPTION

This module provides all BROWSERESULTMASK enums as Perl constants.
...
=item BROWSERESULTMASK_NONE

=item ...

=item BROWSERESULTMASK_TARGETINFO

Export specific BROWSERESULTMASK constants into the OPCUA::Open64541 name
space.

=item :BROWSERESULTMASK

Exports all BROWSERESULTMASK constants into the OPCUA::Open64541 name space.
