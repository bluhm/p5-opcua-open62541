...
my %attributeid_names = OPCUA::Open62541::get_mapping_attributeid_names;
...
sub get_attributes {
    ...
    @attributes = map { $attributeid_names{$_} // $_ } @attributes;
...
sub get_references {
    ...
    my $result_mask       = $args{result_mask};
	...
	NodeId_identifierType => OPCUA::Open62541::NODEIDTYPE_NUMERIC,
